  ...
  return (
    <div className="mt-20">
      ...
      <div className="bg-card border border-border overflow-hidden">
        <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 bg-muted border-b border-border text-xs font-semibold text-foreground uppercase tracking-widest">
        ...
        <div className="divide-y divide-border">
          {associates.length === 0 ? (
            <div className="px-6 py-10 text-center text-sm text-foreground">
            ...
            <div key={a.id} className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 px-6 py-4 items-center">
              <div className="col-span-1 md:col-span-9 text-sm font-medium text-foreground">{a.name}</div>
              <div className="col-span-1 md:col-span-3 text-sm md:text-right text-foreground">{a.sharedTenders}</div>
            </div>
          ))
          }
        </div>

        {total > 0 && <div className="flex flex-col items-center gap-3 px-4 py-4 border-t border-border">
